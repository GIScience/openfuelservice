...
def upgrade():
    ...
    op.create_index(
        op.f("ix_envirocarsensorrawstatistic_id"),
        "envirocarsensorrawstatistic",
        ["id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id"], ["envirocarsensor.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["name"],
            ["envirocarphenomenon.id"],
    ...
    op.create_index(
        op.f("ix_envirocarsensorstatistic_name"),
        "envirocarsensorstatistic",
        ["name"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["track_id"], ["envirocartrack.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.create_table(
        "wikicarenvirocar",
        sa.Column("envirocar_sensor_id", sa.String(), nullable=False),
        sa.Column("wikicar_id", sa.Integer(), nullable=False),
        sa.Column("matching_accuracy", sa.Float(), nullable=False),
        sa.ForeignKeyConstraint(
            ["envirocar_sensor_id"],
            ["envirocarsensor.id"],
            onupdate="CASCADE",
        ...
        sa.ForeignKeyConstraint(
            ["wikicar_id"], ["wikicar.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("envirocar_sensor_id", "wikicar_id"),
    )
    op.create_index(
        op.f("ix_wikicarenvirocar_envirocar_sensor_id"),
        "wikicarenvirocar",
        ["envirocar_sensor_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_wikicarenvirocar_matching_accuracy"),
        "wikicarenvirocar",
        ["matching_accuracy"],
        unique=False,
    )
    op.create_index(
        op.f("ix_wikicarenvirocar_wikicar_id"),
        "wikicarenvirocar",
        ["wikicar_id"],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(op.f("ix_wikicarenvirocar_wikicar_id"), table_name="wikicarenvirocar")
    op.drop_index(
        op.f("ix_wikicarenvirocar_matching_accuracy"), table_name="wikicarenvirocar"
    )
    op.drop_index(
        op.f("ix_wikicarenvirocar_envirocar_sensor_id"), table_name="wikicarenvirocar"
    )
    op.drop_table("wikicarenvirocar")
    op.drop_index(
        op.f("ix_envirocartrackmeasurement_track_id"),
    ...
    op.drop_index(
        op.f("ix_envirocarsensorstatistic_name"), table_name="envirocarsensorstatistic"
    )
    op.drop_index(
    ...
    op.drop_index(
        op.f("ix_envirocarsensorrawstatistic_id"),
        table_name="envirocarsensorrawstatistic",
    )
    op.drop_table("envirocarsensorrawstatistic")
