...
def upgrade():
    ...
    op.add_column(
        "carfueldatacar", sa.Column("manual_or_automatic", sa.String(), nullable=True)
    )
    op.add_column("carfueldatacar", sa.Column("powertrain", sa.String(), nullable=True))
    op.add_column(
        "carfueldatacar", sa.Column("engine_power_ps", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("engine_power_kw", sa.Float(), nullable=True)
    )
    ...
    op.add_column(
        "carfueldatacar", sa.Column("testing_scheme", sa.String(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("wltp_imperial_low", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("wltp_imperial_medium", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("wltp_imperial_high", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar",
    ...
    op.add_column(
        "carfueldatacar", sa.Column("wltp_imperial_combined", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar",
    ...
    op.add_column(
        "carfueldatacar", sa.Column("wltp_metric_low", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("wltp_metric_medium", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("wltp_metric_high", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("wltp_metric_extra_high", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("wltp_metric_combined", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar",
    ...
    op.add_column(
        "carfueldatacar", sa.Column("wltp_co2_weighted", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar",
        sa.Column("equivalent_all_electric_range_miles", sa.Float(), nullable=True),
    )
    op.add_column(
        "carfueldatacar",
        sa.Column("equivalent_all_electric_range_km", sa.Float(), nullable=True),
    )
    op.add_column(
        "carfueldatacar",
        sa.Column("electric_range_city_miles", sa.Float(), nullable=True),
    )
    op.add_column(
        "carfueldatacar", sa.Column("electric_range_city_km", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("emissions_co_m   g_km", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("thc_emissions_mg_km", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("emissions_nox_mg_km", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar",
    ...
    op.add_column(
        "carfueldatacar", sa.Column("particulates_no_mg_km", sa.Float(), nullable=True)
    )
    op.add_column(
        "carfueldatacar", sa.Column("noise_level_dba", sa.Float(), nullable=True)
    )
    op.alter_column(
        "carfueldatacar", "description", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column(
        "carfueldatacar", "transmission", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column(
        "carfueldatacar", "engine_capacity", existing_type=sa.Integer(), nullable=True
    )
...
def downgrade():
    ...
    op.add_column(
        "carfueldatacar",
        sa.Column(
            "thc_plus_nox_emissions_mg_per_km",
            postgresql.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
    ...
    op.alter_column(
        "carfueldatacar", "description", existing_type=sa.VARCHAR(), nullable=False
    )
