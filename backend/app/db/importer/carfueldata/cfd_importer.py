...
class CarFuelDataImporter(BaseImporter):
    ...
    def update_cfs_hashes(self, cfd_car_object: CarFuelDataCar):
    ...
    def _store_cfd(self, cfd_car_import: CFDImportCar):
    ...
    def import_cfd_reader(self, cfd_reader: CarFuelDataReader):
